...
const authController = {
    ...
    try {
      ...
      await sendGmail({
        ...
        text:
          ...
          `------------------------\n\n` +
          `This code is valid for 1 hour. If you did not request a password reset, please ignore this email.\n\n` +
          `Best regards,\n` +
          `The MemoBuddy Team`,
      });
  ...
  async handleCallback(req, res) {
    try {
      ...
      const redirectUrl = new URL("LoginSuccess", "http://localhost:3000");
      redirectUrl.searchParams.append("accessToken", tokens.access_token);
      redirectUrl.searchParams.append("refreshToken", tokens.refresh_token);
      redirectUrl.searchParams.append("expiryDate", tokens.expiry_date);
