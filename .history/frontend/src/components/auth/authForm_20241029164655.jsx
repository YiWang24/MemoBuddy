  ...
  return (
    <form className="flex flex-col gap-4 items-center justify-center w-[80%] h-full">
      ...
      <div className="flex flex-col justify-center items-start gap-2 w-full">
        ...
        <label
          htmlFor="password"
          className="w-full justify-between   font-normal text-[#666666] text-base tracking-[0] leading-[normal] p-0 pl-0"
        >
          <span>Password</span><span><Image src={hide} alt="Hide password" className="mr-1" /> Hide</span>
        </label>
        <input
          id="password"
          placeholder="********"
