...
describe('sendGmail', () => {
    it('should configure the transporter correctly', async () => {
        const tokens = { refreshToken: 'test-refresh-token', accessToken: 'test-access-token' };
        ...
        await sendGmail({ to: 'recipient@example.com', subject: 'Test Subject', text: 'Test Text' });
    ...
    it('should send an email with the correct options', async () => {
        ...
        await sendGmail({ to: 'recipient@example.com', subject: 'Test Subject', text: 'Test Text', html: '<p>Test HTML</p>' });
    ...
    it('should log an error if sending email fails', async () => {
        ...
        expect(consoleErrorMock).toHaveBeenCalledWith('Error sending email:', new Error('Failed to send email'));
    ...
    it('should only include html if text is not provided', async () => {
        ...
        await sendGmail({ to: 'recipient@example.com', subject: 'Test Subject', html: '<p>Test HTML</p>' });
