...
const STAGE_CONTENT = {
  email: {
    ...
    cardBody: "Enter your email to receive a verification code.",
    cardFooter: "Back to login",
  },
  code: {
    cardTitle: "Enter Verification Code",
    buttonTitle: "Verify Code",
    cardBody: "We have sent a 6-digit code to your email.",
    cardFooter: "Resend code",
  },
  password: {
    cardTitle: "Set New Password",
    buttonTitle: "Reset Password",
    cardBody: "Enter your new password below.",
    cardFooter: "Back to login",
  },
};
