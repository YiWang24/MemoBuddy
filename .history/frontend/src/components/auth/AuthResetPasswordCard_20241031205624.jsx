...
const AuthResetPasswordCard = ({title,buttonTitle}) => {
  ...
  return (
    <div className="w-[60%] h-[60%] flex flex-col items-center gap-4 border-red-500 border-2">
      ...
      <div className="text-[16px] [text-decoration:underline] font-medium font-poppins text-gray text-right mt-10 cursor-pointer hover:text-blue-500 transition duration-300 ease">
