  ...
  return (
    <div className=" w-full  h-screen flex flex-col items-center justify-center">
      ...
      <div className="h-[60%] w-[60%] flex  flex-row  gap-8 mt-4">
        {/* login form */}
        <div className="w-[50%]  flex justify-center items-center border-cyan-400 border-2 ">
          <AuthForm formTitle="Log in" />
        </div>
        {/* OR */}
        <Divider />
        {/* login button */}
        <div className="w-[50%]  flex items-center justify-center border-cyan-400 border-2">
