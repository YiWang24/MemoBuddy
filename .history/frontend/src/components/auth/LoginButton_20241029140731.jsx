...
const LoginButton = ({ imgURL, alt, onClick, text }) => {
  return (
    <div className="w-full relative rounded-[40px] bg-white  border-[1px] border-black box-border h-14  overflow-hidden shrink-0  text-left text-[22px] text-black font-times-new-roman  m- ">
