    ...
    <div className=" w-full  h-screen flex flex-col items-center justify-center">
      ...
      <div className="h-[60%] w-[60%] flex  flex-row  ">
        ...
        <div className="flex flex-col items-center justify-center gap-4  w-[0.5%] ">
          <div className="w-[100%] h-[50%] bg-slate-400 border-2"></div>
          <div className="w-[80%] h-[10%] flex items-center justify-center gap-4">
            <div>OR</div>
          </div>
          <div className="w-[100%] h-[40%] bg-slate-400 border-2"></div>
        </div>
        {/* login button */}
