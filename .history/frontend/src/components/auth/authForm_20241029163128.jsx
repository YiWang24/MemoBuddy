  ...
  return (
    <form className="flex flex-col gap-4 items-center justify-center w-[80%] h-full border-2 border-green-600">
      ...
      <div className="flex flex-col justify-center items-start gap-2 w-full">
        <label htmlFor="email" className="w-full border-[none] [background:none] [font-family:'Poppins-Regular',Helvetica] font-normal text-[#666666] text-base tracking-[0] leading-[normal] p-0 pl-0">
          Email Address
        </label>
        <input
          id="email"
