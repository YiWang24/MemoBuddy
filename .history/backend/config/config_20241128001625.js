...
// Contains configuration for the application, database, session, google OAuth, email, swagger, openWeatherMap, and CORS
...
// The configuration object is exported to be used in other parts of the application
// The configuration object is used to configure the application, database, session, google OAuth, email, swagger, openWeatherMap, and CORS
// The configuration values are loaded from environment variables
...
const config = {
  ...
  swaggerDefinition: {
    ...
    info: {
      title: "MemoBuddy API",
      version: "1.0.0",
      description: "API Documentation for MemoBuddy",
      license: {
