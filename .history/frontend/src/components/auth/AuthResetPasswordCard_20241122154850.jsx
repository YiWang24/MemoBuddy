        ...
        <a href={link}>
          ...
          {stage === "code" && resendLinkText && (
            <button
              ...
              className=" bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 transition"
            >
              {resendLinkText}
            </button>
          )}
