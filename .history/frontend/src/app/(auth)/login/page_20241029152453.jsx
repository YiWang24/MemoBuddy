...
export default function Login() {
  ...
  return (
    <div className=" w-full  h-screen flex flex-col items-center justify-center">
      ...
      <div className="h-[20%] flex flex-col items-center justify-start gap-6 relative w-fit mt-[-1.00px] [font-family:'Poppins-Medium',Helvetica] font-medium text-[#111111] text-base text-right tracking-[0] leading-[normal] underline">
        <a>Forgot password?</a>
      </div>
    </div>
  );
